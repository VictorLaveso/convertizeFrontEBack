...
![Imgur](https://convertize.com.br/m/devshop.png)
...
Adoraríamos que você utilizasse [Python](http:/www.python.org/), [Go](https://golang.org/) ou [Node](https://nodejs.org/) para construir sua API. Caso contrário, justifique sua escolha de tecnologia.
